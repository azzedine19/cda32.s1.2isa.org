...
<div class="blog-entry justify-content-end mb-md-5">
    <a href="./page-information-<?php echo $idnews; ?>" class="block-20 img"<?php if($photo == ' ') { ?> style="background-image: url('images/image_1.jpg');"> <?php } else { echo '">'.'<img class="imgsize" src="'.$photo.'">';} ?>
    </a>
    <div class="text px-md-5 pt-4">
        ...
        <p>
            <a href="./page-information-<?php echo $idnews; ?>" class="btn btn-primary">Consulter <span class="icon-long-arrow-right"></span></a>
